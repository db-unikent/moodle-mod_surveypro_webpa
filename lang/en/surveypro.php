...
$string['confirm_freechainitems_newparent'] = 'Making available the element "{$a->itemcontent}", all the dependencies of element "{$a->parentcontent}" will be made available too.<br />Dependencies are the elements in position: {$a->dependencies}.<br />Do you confirm this action?';
$string['confirm_freechainitems'] = 'Reserving the element "{$a->itemcontent}" you are going to reserve all its ancestors.<br />Ancestors are the elements in position: {$a->ancestors}.<br />Do you confirm this action?';
...
$string['confirm_reservechainitems_newparent'] = 'Reserving the element "{$a->itemcontent}", all the dependencies of element "{$a->parentcontent}" will be made reserved too.<br />Dependencies are the elements in position: {$a->dependencies}.<br />Do you confirm this action?';
...
$string['hassubmissions_alert_activitycompletion'] = '<br />With items modificaton the activity completion status will change too.<br />You have been warned.';
...
$string['hassubmissions_danger'] = '<br />"In progress" responses...<ul><li>are subject to deletion in 4 hours if save/resume is not allowed;</li><li>are subject to deletion in the number of hours set into surveypro settings page if save/resume is allowed.</li></ul>';
